...
export function Button({
  ...
  const baseStyles = 'inline-flex items-center justify-center font-bold transition-all duration-200 rounded-xl focus:outline-none focus:ring-2 focus:ring-offset-2 disabled:opacity-50 disabled:cursor-not-allowed cursor-pointer active:scale-98'
  ...
  const variants = {
    ...
    ghost: 'bg-transparent hover:bg-slate-100 text-slate-600 focus:ring-slate-300 border border-transparent',
